defmodule MyFood.Pagination do
  import Ecto.Query
  alias MyFood.Repo
  ...
  def page(query, %{"page" => page, "per_page" => per_page})
      when is_binary(page) and is_binary(per_page) do
    page(query, String.to_integer(page), per_page: String.to_integer(per_page))
  end
